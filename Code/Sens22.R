...
FilePath.Sens1 <- CreateSubFolder(FilePath, "22.PIV")
...
# SensDat1 <- All_Vir[Index_of_Wave != 0 & Virus_name %in% c('RSV', 'PIV', 'MPV', 'sCoV', 'RV', 'AdV', 'IFVA', 'IFVB') & Outcome_type == "C"] %>%
#   mutate(Virus_name = as_factor(Virus_name),
...
#          hemisphere = if_else(lat > 0, "North hemisphere", "South hemisphere")) %>% setDT()
